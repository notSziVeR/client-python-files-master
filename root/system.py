...
def dbg_chat(message = ""):
	...
	try:
		...
		chat_str = "<debug: no inspect module> {}".format(message)

	import chat
	chat.AppendChat(chat.CHAT_TYPE_GUILD, chat_str)
...
__builtin__.translate = translatemanager.get
