...
class BuffNPCWindow(ui.ScriptWindow):
	...
	def SetEXPInfo(self, level, cur_exp, exp):
		...
		self.toolTipExp.SetText(uiScriptLocale.ASLAN_BUFF_HOVER_EXP_INFO % (localeInfo.NumberToEXPString(str(cur_exp)), localeInfo.NumberToEXPString(str(exp)), exp_perc))
