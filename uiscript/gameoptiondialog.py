...
if app.ENABLE_PREMIUM_PRIVATE_SHOP:
	CUR_LINE_Y += LINE_STEP
	window["height"] = window["height"] + 35
	window["width"] = window["width"] + 5
	window["children"][0]["height"] = window["children"][0]["height"] + 35
	window["children"][0]["width"] = window["children"][0]["width"] + 5
	window["children"][0]["children"] = window["children"][0]["children"] + [
